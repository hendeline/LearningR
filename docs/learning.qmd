...
Styling:
Skrev command+shift+p --> "style active file", og så skulle den installere en pakke. Når denne funktion kører, fjerner den de visualiseringer, vi har lavet, men de kan bare køres igen, så man kan se det. Den justerer teskten i koden og ikke selve plottene. Dette gjort nu, og der står "using style transformers....." i console, og det skal bruges nu:
