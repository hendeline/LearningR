...
## Øvelse i sektion 21: Make multi-dimensional plots
...
---- Sektion 22: Split, apply, and combine --------
...
Vil gruppere by gruppe-kollonnen (ente kontroller eller first degree relavtives).
Koden siger "for alle data med control, regn mean age" og "for alle data med bmi, beregn BMI".
ungroup bruges efter, så man analuerer de grupper, man er ved at lave? Good practise, så man ikke ved en fejl har lavet uønskede grupper.
...
Summarise kan være nice at bruge, når man skal præsentere resulteter for andre. 
Gør resultatet pænt præsentabelt med "knitr"-funktion:
...
Gør tabel mere readable: 
Ændrer til at tal i tabel kun skal have 1 decimal på tal med "round xxxx ,1" OG ændre kolonnenavne ved at replace "mean_age" med "Mean age" med "" fordi det er bogstaver OG laver figurtekst med "#|tbl-cap" (table caption) OG laver reference i tekten med "label". De to sidste ting kan kun ses, når man laver "Render". 
